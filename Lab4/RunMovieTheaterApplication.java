    ...
    public static void main(String[] args) {
    	...
    	try {
            ...
            connection = DriverManager.getConnection(
                                                     "jdbc:postgresql://cse180-db.lt.ucsc.edu/nksalim",
                                                     "nksalim",
                                                     "apple");
			...
			String priceCode = "B";
    		System.out.println(app.getShowingsCount(priceCode));
			String name_1 = "Avatar 1";
			int movieID_1 = 101;
			System.out.println(app.updateMovieName(movieID_1, name_1));
			String name_2 = "Star Wars: A New Hope";
			int movieID_2 = 888;
			System.out.println(app.updateMovieName(movieID_2, name_2));



			int maxTicketCount_1 = 15;
			System.out.println(app.reduceSomeTicketPrices(maxTicketCount_1));
			int maxTicketCount_2 = 99;
			System.out.println(app.reduceSomeTicketPrices(maxTicketCount_2));
